...
import "./page.css";
import { LoggedInUser, TaskItem } from "@/lib/types";
...
export default function TasksClient({
  ...
  const handleDeleteList = useCallback(
    ...
    [removeTaskList, selectedListId, user?.taskLists, setSelectedListId]
  );
  ...
  useEffect(() => {
    if (
      ...
      // Use initialListId from server if available, otherwise first list
      setSelectedListId(initialListId || user.taskLists[0]?.id || null);
    }
  }, [user, selectedListId, setSelectedListId, initialListId]);
      ...
      <div className="tasks-page__content">
        {selectedList ? (
          <TaskList
            ...
            initialTasks={selectedListId === initialListId ? initialTasks : undefined}
          />
        ) : (
